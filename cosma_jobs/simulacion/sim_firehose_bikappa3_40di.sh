...
#  Coste ~4x un caso estandar; se corre con np 48x48
...
#  (src/psc_firehose_bikappa3_bigbox40.cxx) que hay que COMPILAR una
#  sola vez antes de enviar:
#
#    cd /cosma7/data/dp433/dc-mart18/pcseditado
#    BUILD_DIR="$PWD/build" BUILD_JOBS=4 \
#      PSC_TARGETS=psc_firehose_bikappa3_bigbox40 \
