...
// βi∥=3.0  Ai=0.6  βe∥=1.0  Ae=1.0 | mr=200, 2000 ppc, 1408²
...
void setupParameters() {
  ...
  g.vA_over_c=0.05; g.beta_e_par=1.0; g.beta_i_par=3.0;
  g.Ti_perp_over_Ti_par=0.6; g.Te_perp_over_Te_par=1.0; g.n=1.0;
...
void run() {
  mpi_printf(MPI_COMM_WORLD, "*** Setting up F-W-bM (Firehose Weak Bi-Maxwellian) ...\n");
  setupParameters();
  ...
  outp_params.data_dir = "."; outp_params.basename = "prt_F_W_bM";
