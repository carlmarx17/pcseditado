// psc_W_W_bM — Whistler Weak Bi-Maxwellian
// βi∥=1.0  Ai=1.0  βe∥=0.5  Ae=Te⊥/Te∥=1.5 | mr=200, 2000 ppc, 1408²
...
void setupParameters() {
  ...
  // Whistler Weak: βi∥=1.0, Ai=1.0, βe∥=0.5, Ae=1.5
  g.vA_over_c=0.05; g.beta_e_par=0.5; g.beta_i_par=1.0;
  g.Ti_perp_over_Ti_par=1.0; g.Te_perp_over_Te_par=1.5; g.n=1.0;
...
void run() {
  mpi_printf(MPI_COMM_WORLD, "*** Setting up W-W-bM (Whistler Weak Bi-Maxwellian) ...\n");
  setupParameters();
  ...
  outp_params.data_dir = "."; outp_params.basename = "prt_W_W_bM";
