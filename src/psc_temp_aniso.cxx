...
{
  psc_params.nmax = envOrDefault("PSC_NMAX", 40001); // Reduced default steps
  psc_params.cfl = 0.95;
  ...
  g.vA_over_c = 0.05; // Reduced Alfven velocity
  g.beta_e_par = 1.0;
  g.beta_i_par = 5.0;
...
Grid_t* setupGrid()
{
  ...
  Int3 np{1, 8, 8}; // Increased decomposition for server
