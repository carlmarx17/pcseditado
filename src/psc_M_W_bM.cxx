...
// βi∥=6.0  Ai=1.5  βe∥=1.0  Ae=1.0 | mr=200, 2000 ppc, 1408²
...
void setupParameters() {
  ...
  g.Ti_perp_over_Ti_par=1.5; g.Te_perp_over_Te_par=1.0; g.n=1.0;
...
void run() {
  mpi_printf(MPI_COMM_WORLD, "*** Setting up M-W-bM (Mirror Weak Bi-Maxwellian) ...\n");
  setupParameters();
  ...
  outp_params.data_dir = "."; outp_params.basename = "prt_M_W_bM";
