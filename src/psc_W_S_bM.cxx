// psc_W_S_bM — Whistler Strong Bi-Maxwellian
// βi∥=1.0  Ai=1.0  βe∥=0.5  Ae=Te⊥/Te∥=3.0 | mr=200, 2000 ppc, 1408²
// Electron-driven whistler anisotropy instability (Te⊥ > Te∥)
...
void setupParameters() {
  ...
  // Whistler Strong: βi∥=1.0, Ai=1.0 (ions isotropic), βe∥=0.5, Ae=3.0
  g.vA_over_c=0.05; g.beta_e_par=0.5; g.beta_i_par=1.0;
  g.Ti_perp_over_Ti_par=1.0; g.Te_perp_over_Te_par=3.0; g.n=1.0;
...
void run() {
  mpi_printf(MPI_COMM_WORLD, "*** Setting up W-S-bM (Whistler Strong Bi-Maxwellian) ...\n");
  setupParameters();
  ...
  outp_params.data_dir = "."; outp_params.basename = "prt_W_S_bM";
