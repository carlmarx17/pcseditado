...
void setupParameters() {
  ...
  g.vA_over_c=0.05; g.beta_e_par=1.0; g.beta_i_par=10.0;
  g.Ti_perp_over_Ti_par=0.1; g.Te_perp_over_Te_par=1.0; g.n=1.0;
...
void run() {
  mpi_printf(MPI_COMM_WORLD, "*** Setting up F-S-bM (Firehose Strong Bi-Maxwellian) ...\n");
  setupParameters();
