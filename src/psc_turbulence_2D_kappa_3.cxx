...
void setupParameters()
{
  ...
  //read_checkpoint_filename = "checkpoint_8000.bp";
...
Grid_t* setupGrid()
{
  ...
  double domain_size = 2.0 * M_PI * 8. * g.d_i;

  Grid_t::Real3 LL = {1.0, domain_size, domain_size};
  Int3         gdims = {1, 4488, 4480};
  Int3         np    = {1, 22, 28}; // 32 patches for 32 MPI ranks
